...
const SideBarLargeScreen = () =>{
   ...
   const pathName = path.pathname.split('/')[1]
    ...
    return (
<div className=" hidden md:flex  flex-col w-[250px] min-h-[100vh] shadow-black shadow-lg gap-5 cursor-default">
    ...
    <div className='flex flex-col gap-2 text-sm font-poppins'>
        ...
        <div className={`${(dashBoardActiveButton.dashBoard.isActive) && ' border-navBarActiveColor  text-navBarActiveColor ' }  bg-gray-400 bg-opacity-20  p-2  flex gap-6  border-s-4  rounded-sm`} onClick={()=>{
     makeButtonActive('dashboard')
        ...
        <div className={`${(dashBoardActiveButton.propertyList.isActive) && ' border-navBarActiveColor  text-navBarActiveColor ' }  bg-gray-400 bg-opacity-20  p-2  flex gap-6  border-s-4  rounded-sm`} onClick={()=>{
     makeButtonActive('propertyList')
        ...
        <div className={`${(dashBoardActiveButton.panchyatWise.isActive) && ' border-navBarActiveColor  text-navBarActiveColor ' }  bg-gray-400 bg-opacity-20  p-2  flex gap-6  border-s-4  rounded-sm`} onClick={()=>{
